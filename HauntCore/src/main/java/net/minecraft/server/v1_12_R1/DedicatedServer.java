...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    public boolean init() throws IOException { // CraftBukkit - decompile error
        ...
        thread.start();
        DedicatedServer.LOGGER.info("Starting modificated minecraft server version 1.12.2, special for HauntMC");
        if (Runtime.getRuntime().maxMemory() / 1024L / 1024L < 512L) {
            DedicatedServer.LOGGER.warn("To start the server with more ram, launch it as \"java -Xmx1024M -Xms1024M -jar Core.jar\"");
        }
        ...
        this.propertyManager = new PropertyManager(this.options); // CraftBukkit - CLI argument support
            ...
            this.setPVP(this.propertyManager.getBoolean("pvp", false));
            ...
            if (this.P() < 0) {
                this.setPort(this.propertyManager.getInt("server-port", 25567));
            }
            // Spigot start
            ...
            if (!NameReferencingFileConverter.a(this.propertyManager)) {
                ...
                if (this.S() == null) {
                    this.setWorld(this.propertyManager.getString("level-name", "Hub"));
                }
                ...
                if (this.propertyManager.a("announce-player-achievements")) {
                    this.worlds.get(0).getGameRules().set("announceAdvancements", this.propertyManager.getBoolean("announce-player-achievements", false) ? "true" : "false"); // CraftBukkit
                ...
                if (this.propertyManager.getBoolean("enable-rcon", false)) {
                    ...
                    this.p.a();
                    this.remoteConsole = new org.bukkit.craftbukkit.v1_12_R1.command.CraftRemoteConsoleCommandSender(this.remoteControlCommandListener); // CraftBukkit
                }
